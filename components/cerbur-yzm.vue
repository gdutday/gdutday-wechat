<template>
	<view>
		<modal ref="modal">
			<comfirm @success="success" @fail="fail" title="输入验证码以更新" :confirmText="confirmText" :comfirmColor="!loading?'':'background-color:rgba(184,184,184,1);'">
		        <view class="text-center">
		            <image @tap="refreshYzm" :src="yzm" class="text-center" style="width: 150rpx;height: 120rpx">
		        </view>
