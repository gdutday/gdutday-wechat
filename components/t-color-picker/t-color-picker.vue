<template>
	<modal type="bottomModal" @show="afterShow" ref="modal">
		<view class="t-header">
			<view class="t-header-button text-lg" @click="close">取消</view>
			<view class="t-header-button text-xl">
				<slot></slot>
			</view>
			<view class="t-header-button text-lg" :style="$themeFont" @click="confirm">确认</view>
		</view>
		...
		<view class="t-result__box">
			...
			<template v-else>
				<view class="t-result__item"> 
					<input @blur="blur" class="t-result__box-input t-input-height"  maxlength="3" v-model="rgba.r"></input>
					<view class="t-result__box-text">R</view>
				</view>
				<view class="t-result__item">
					<input @blur="blur" class="t-result__box-input t-input-height" maxlength="3" v-model="rgba.g"></input>
					<view class="t-result__box-text">G</view>
				</view>
				<view class="t-result__item">
					<input @blur="blur" class="t-result__box-input t-input-height" maxlength="3" v-model="rgba.b"></input>
					<view class="t-result__box-text">B</view>
				</view>
				<view class="t-result__item">
					<input  @blur="blur" class="t-result__box-input t-input-height" v-model="rgba.a"></input>
